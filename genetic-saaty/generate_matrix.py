...
def generate_matrix():
    ...
    size = 8  # Set size to 4 for a 4x4 matrix
...
def save_matrices_to_file(filename, num_matrices=10000):
...
save_matrices_to_file("d:/research/code/genetic-saaty/10000_scale9_size8.txt")
